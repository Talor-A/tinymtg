...
const CORPUS_CARDS = [
	...
	loadCardFixture("p/plains"),
	loadCardFixture("i/island"),
	loadCardFixture("s/swamp"),
	loadCardFixture("m/mountain"),
	...
	loadCardFixture("g/gladecover_scout"),
	loadCardFixture("k/kalonian_behemoth"),
	loadCardFixture("r/rangers_guile"),
	...
	loadCardFixture("d/desolation_twin"),
	...
	loadCardFixture("a/ash_barrens"),
	loadCardFixture("g/ghost_lit_nourisher"),
	loadCardFixture("g/ghost_lit_raider"),
	loadCardFixture("g/ghost_lit_redeemer"),
	loadCardFixture("i/ironhoof_boar"),
	loadCardFixture("m/mnemonic_sphere"),
	loadCardFixture("s/shinen_of_flights_wings"),
	loadCardFixture("s/shinen_of_furys_fire"),
	loadCardFixture("t/twinshot_sniper"),
	loadCardFixture("b/balamb_t_rexaur"),
	loadCardFixture("c/canyon_crawler"),
	loadCardFixture("c/chartooth_cougar"),
	loadCardFixture("d/daggermaw_megalodon"),
	loadCardFixture("e/elvish_aberration"),
	loadCardFixture("f/furnace_host_charger"),
	loadCardFixture("g/generous_ent"),
	loadCardFixture("h/hill_gigas"),
	loadCardFixture("i/igneous_pouncer"),
	loadCardFixture("j/jennika_bad_apple_big_sister"),
	loadCardFixture("l/lorien_revealed"),
	loadCardFixture("n/noble_templar"),
	loadCardFixture("n/nurturing_bristleback"),
	loadCardFixture("o/oliphaunt"),
	loadCardFixture("p/pale_recluse"),
	loadCardFixture("r/rabaroo_troop"),
	loadCardFixture("r/rampaging_spiketail"),
	loadCardFixture("s/saber_tooth_moose_lion"),
	loadCardFixture("s/sanctum_plowbeast"),
	loadCardFixture("s/seismic_monstrosaur"),
	loadCardFixture("s/shepherding_spirits"),
	loadCardFixture("s/shoreline_ranger"),
	loadCardFixture("s/slavering_branchsnapper"),
	loadCardFixture("s/soaring_sandwing"),
	loadCardFixture("s/stockman_mad_fly_entist"),
	loadCardFixture("t/timberland_ancient"),
	loadCardFixture("v/valley_rannet"),
	loadCardFixture("w/wirewood_guardian"),
	loadCardFixture("b/boon_of_the_wish_giver"),
	loadCardFixture("d/drannith_healer"),
	loadCardFixture("d/drannith_stinger"),
	loadCardFixture("r/renewed_faith"),
	...
	loadCardFixture("m/metal_fatigue"),
	loadCardFixture("d/darksteel_sentinel"),
	loadCardFixture("t/timetwister"),
	loadCardFixture("w/worldspine_wurm"),
	loadCardFixture("w/writhing_chrysalis"),
	loadCardFixture("w/wrath_of_god"),
